...
public class C_Quiz extends AppCompatActivity {
    ...
    private C_Question_Library question_library = new C_Question_Library();
        ...
        btnChoice1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(btnChoice1.getText() == mAnswer){
                    ...
                    updateScore(mScore);
                    updateQuestion();
                    Toast.makeText(C_Quiz.this,"Correct",Toast.LENGTH_SHORT).show();
                }else if(btnChoice1.getText() != mAnswer){
                    mScore -= 1;
                    updateScore(mScore);
                    Toast.makeText(C_Quiz.this,"Wrong! \nCorrect Answer Was : "+mAnswer,Toast.LENGTH_LONG).show();
                    updateQuestion();
                }
            }
        });
    ...
    private void updateQuestion(){
        if (qN < 18) {
            mQuestionView.setText("Q." + qN + ") " + C_Question_Library.getQuestion(questionNumber));
            btnChoice1.setText(C_Question_Library.getChoice1(questionNumber));
            btnChoice2.setText(C_Question_Library.getChoice2(questionNumber));
            btnChoice3.setText(C_Question_Library.getChoice3(questionNumber));
            btnChoice4.setText(C_Question_Library.getChoice4(questionNumber));
