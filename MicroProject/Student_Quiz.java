...
public class Student_Quiz extends AppCompatActivity {
        ...
        btnChoice1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(btnChoice1.getText() == mAnswer){
                    ...
                    updateScore(mScore);
                    updateQuestion();
                    Toast.makeText(Student_Quiz.this,"Correct",Toast.LENGTH_SHORT).show();
                }else if(btnChoice1.getText() != mAnswer){
                    mScore -= 1;
                    updateScore(mScore);
                    Toast.makeText(Student_Quiz.this,"Wrong! \nCorrect Answer Was : "+mAnswer,Toast.LENGTH_LONG).show();
                    updateQuestion();
                }
            }
        });
    ...
    private void updateQuestion(){
        if (qN < 32) {
            mQuestionView.setText("Q." + qN + ") " + Question_Library.getQuestion(questionNumber));
            btnChoice1.setText(Question_Library.getChoice1(questionNumber));
            btnChoice2.setText(Question_Library.getChoice2(questionNumber));
            btnChoice3.setText(Question_Library.getChoice3(questionNumber));
            btnChoice4.setText(Question_Library.getChoice4(questionNumber));
